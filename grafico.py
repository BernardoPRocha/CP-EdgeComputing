...
def plotar_grafico(luminosity_data):
    ...
    media_luminosidade = sum(luminosidade) / len(luminosidade)

    plt.figure(figsize=(12, 6))
    plt.plot(tempos, luminosidade, marker='o', linestyle='-', color='r')

    # Adicionar uma linha horizontal para a média
    plt.axhline(media_luminosidade, color='b', linestyle='--', label=f'Média de Luminosidade: {media_luminosidade:.2f}')
